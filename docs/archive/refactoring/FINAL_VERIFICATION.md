...
```bash
# Nueva URL
curl http://localhost:3001/exhibitions/galaxy/ethernicapsule
✅ 200 OK

# Redirect automático
curl -I http://localhost:3001/ethernicapsule
✅ 307 Temporary Redirect
✅ Location: /exhibitions/galaxy/ethernicapsule
```
...
- `/lib/audio.ts` → `/exhibitions/galaxy/ethernicapsule/lib/audio.ts`
...
- ✅ `/exhibitions/galaxy/ethernicapsule/compose`
- ✅ `/exhibitions/galaxy/ethernicapsule/preview`
- ✅ `/exhibitions/galaxy/ethernicapsule/sealed`
- ✅ `/exhibitions/galaxy/ethernicapsule/sealing`
- ✅ `/exhibitions/galaxy/ethernicapsule/unlock`
- ✅ `/exhibitions/galaxy/ethernicapsule/letter/[id]`
...
### Verificado:
- ✅ URLs actualizadas a `/exhibitions/galaxy/ethernicapsule/*`
...
- Move EterniCapsule to /exhibitions/galaxy/ethernicapsule/
...
BREAKING CHANGE: EterniCapsule URLs changed from /ethernicapsule to /exhibitions/galaxy/ethernicapsule
...
# Debería redirectar a /exhibitions/galaxy/ethernicapsule
```
