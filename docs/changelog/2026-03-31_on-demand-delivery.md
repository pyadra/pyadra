...
**File**: `/exhibitions/galaxy/ethernicapsule/guardian/page.tsx`
...
open "http://localhost:3000/exhibitions/galaxy/ethernicapsule/guardian?token=xxx"
...
2. `/exhibitions/galaxy/ethernicapsule/guardian/page.tsx` - UI page
