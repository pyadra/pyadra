  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((p) => {
        ...
        g.addColorStop(0, "rgba(41,171,226,0.8)");
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 180) {
            ...
            ctx.strokeStyle = `rgba(41,171,226,${0.4 * (1 - dist / 180)})`;
            ctx.lineWidth = 1.5;
            ctx.stroke();
          }
        }
    ...
    >
      <style jsx>{`
        ...
        @keyframes breathe {
          ...
          50% {
            box-shadow: 0 0 60px rgba(41, 171, 226, 0.9);
        ...
        .central-core {
          ...
          box-shadow: 0 0 60px rgba(41, 171, 226, 0.8),
            inset 0 0 40px rgba(41, 171, 226, 0.3);
          left: 50%;
          top: 50%;
        ...
        @keyframes corePulse {
          ...
          50% {
            ...
            box-shadow: 0 0 100px rgba(41, 171, 226, 1);
          }
        }
      ...
      >
        ...
        <section style={{ marginBottom: "80px" }}>
          ...
          >
            Every role is vital to the collective. Choose how you want to
            contribute.
          </p>
          ...
          >
            <div className="role-card">
              ...
              <p style={{ color: "rgba(244, 246, 248, 0.7)" }}>
            ...
            <div className="role-card">
              ...
              <p style={{ color: "rgba(244, 246, 248, 0.7)" }}>
                Connect and amplify collective impact
              </p>
            </div>
          </div>
        </section>
              ...
              >
                <div
                  style={{
                    ...
                    inset: 0,
                    borderRadius: "50%",
                    background: `radial-gradient(circle, ${selectedMember.color}40, transparent)`,
                    filter: "blur(20px)",
                  }}
                />
                <img
              ...
              >
                {selectedMember.contributions.money !== "$0" && (
                  ...
                  >
                    ...
                    <span style={{ color: "#66FFB2" }}>
                      {selectedMember.contributions.money}
                    </span>
                  </div>
                )}
                {selectedMember.contributions.hours > 0 && (
                  ...
                  >
                    ...
                    <span style={{ color: "#29ABE2" }}>
                      {selectedMember.contributions.hours} hours
                    </span>
                  </div>
                )}
                <div
                  ...
                  style={{
                    ...
                    borderColor: "rgba(0, 224, 199, 0.3)",
                  }}
                >
                  <span style={{ fontSize: "18px" }}>🚀</span>
                  <span style={{ color: "#00E0C7" }}>
                    {selectedMember.contributions.projects.length} projects
                  </span>
                </div>
              </div>
            </div>
      ...
      {isModalOpen && (
        <div className="modal" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            >
              <option value="" style={{ background: "#0B1D26" }}>
                Select a role...
              </option>
              <option value="seeder" style={{ background: "#0B1D26" }}>
                🌱 Seeder
              </option>
              <option value="builder" style={{ background: "#0B1D26" }}>
                🛠 Builder
              </option>
              <option value="creator" style={{ background: "#0B1D26" }}>
                💡 Creator
              </option>
              <option value="harvester" style={{ background: "#0B1D26" }}>
                🌐 Harvester
              </option>
            </select>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "linear-gradient(135deg, #29ABE2, #00E0C7)",
                  color: "white",
                  boxShadow: "0 0 30px rgba(41, 171, 226, 0.5)",
                }}
              >
                Join Now
              </button>
