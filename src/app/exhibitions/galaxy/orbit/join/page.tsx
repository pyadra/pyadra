  ...
  if (status === "success") {
    return (
       <div className="text-center py-20 border border-[#39FF14]/20 rounded-2xl bg-[#050A07]/80 backdrop-blur-xl shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
         ...
         <h3 className="text-3xl lg:text-4xl font-serif italic text-[#39FF14] mb-4 drop-shadow-[0_0_15px_rgba(57,255,20,0.3)]">Application recorded.</h3>
         <p className="text-sm font-light font-sans text-[#AEFFA1]/80">Pablo and Eduardo will review your data shortly.</p>
         <Link href="/exhibitions/galaxy/orbit" className="mt-10 inline-block text-[10px] uppercase font-mono tracking-[0.2em] font-bold text-[#39FF14] border-b border-[#39FF14]/30 pb-1 hover:border-[#39FF14] transition-colors">
            Return to Orbit 77
         </Link>
       </div>
    );
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input required name="name" type="text" placeholder="First and last name" className="bg-[#0A120D] border border-[#39FF14]/20 focus:border-[#39FF14] focus:shadow-[0_0_15px_rgba(57,255,20,0.1)] rounded-xl px-5 py-4 text-sm font-sans text-[#F4EFEA] outline-none transition-all placeholder:text-[#AEFFA1]/30" />
      </div>
      
      {/* Email */}
      <div className="flex flex-col gap-2">
        <label className="text-[10px] uppercase font-mono tracking-widest text-[#AEFFA1]/70 font-bold">Your email</label>
        <input required name="email" type="email" placeholder="we'll reply here" className="bg-[#0A120D] border border-[#39FF14]/20 focus:border-[#39FF14] focus:shadow-[0_0_15px_rgba(57,255,20,0.1)] rounded-xl px-5 py-4 text-sm font-sans text-[#F4EFEA] outline-none transition-all placeholder:text-[#AEFFA1]/30" />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <select required name="role" defaultValue={defaultRole} className="appearance-none bg-[#0A120D] border border-[#39FF14]/20 focus:border-[#39FF14] focus:shadow-[0_0_15px_rgba(57,255,20,0.1)] rounded-xl px-5 py-4 text-sm font-sans text-[#F4EFEA] outline-none transition-all cursor-pointer">
      ...
      <main className="relative z-10 w-full max-w-2xl px-6 mx-auto flex flex-col pt-8 md:pt-12">
        ...
        <div className="bg-gradient-to-br from-[#101A14] to-[#0A120D] backdrop-blur-xl border border-[#39FF14]/30 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-[0_0_30px_rgba(57,255,20,0.1)]">
           ...
           <div className="relative z-10">
             ...
             <Link href="/exhibitions/galaxy/orbit#support" className="block w-full py-4 bg-[#39FF14]/10 hover:bg-[#39FF14] border border-[#39FF14]/40 hover:text-[#060B08] text-[#39FF14] rounded-xl text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] font-bold transition-all shadow-[0_0_15px_rgba(57,255,20,0.2)]">
               SUPPORT ORBIT 77 →
             </Link>
           </div>
        </div>
