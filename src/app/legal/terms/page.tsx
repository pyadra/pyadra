    ...
    <main className="min-h-screen bg-black text-[#E3DAC9] font-sans selection:bg-[#FFB000]/20 selection:text-[#FFB000] flex justify-center py-24 md:py-32 px-6">
      <div className="max-w-2xl w-full">
        ...
        <div className="space-y-8 font-light text-sm text-white/50 leading-loose">
          ...
          <p><strong>1. Resource Injections (Contributions):</strong> Actions designated as &quot;Buying a Coffee&quot; or &quot;Sponsoring&quot; on pyadra.io are symbolic contributions to the collective and are non-refundable. They represent energy given to nourish the project node in question.</p>
          <p><strong>2. Equity & Participation:</strong> Formal partnerships and equity distributions (e.g. 10%-100% podcast equity) discussed on the Pyadra dashboard are subject to real-world contractual agreements negotiated directly via invest@pyadra.com.</p>
